...
def main():
    ...
    for msg in messages:
        ...
        for email_element in email_elements:
            if email_element['name'] == 'To':
                if "michelle.cheatham@wright.edu" in email_element['value'] and email_element['value'].count('@wright.edu') < 2:
                    bad_aspects += 1
    ...
    newConditions = {"command": "set", "state": "on", "light": "glow_ball", 
            "rgb_color": [red, 0, blue], "brightness": brightness} 
    params = json.dumps(newConditions).encode('utf8')
    req = urllib.request.Request(lightURL, data=params,
